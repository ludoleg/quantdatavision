...
This version is modified to disable the refinement steps because Scipy is not working on app engine.
The refinement portion is simply commented

All commands were moved to a runprog() function.

Global variable have not all been moved to the function arguments.
...
def runprog(filepath1,namesample,filepath2,DBname,phaselist):
    ...
    XRDdata = open(filename1, 'r').readlines()
    ...
    ################  definition of parameter list for function calls ############
    #   param:  
    #   0 = a sigma
    #   1 = b sigma
    #   2 = 
    #   3 = 
    #   10 = start RIR vector
    #   100 = start index DB2T mineral 1 (step2)
    #   101 = start index Int% mineral 1 (step2)
    #   200 = start index DB2T mineral 2 (step2)
    #   201 = start index Int% mineral 2 (step2)
    #   .....etc
    #################################   LSTSQ REFINEMENT   #######################
