...
def GenerateChart(blobfile):
    ...
    #sys.stdout = open('results.txt','w') #redirect all prints to this log file
    sys.stdout = sio
    ...
    namesample = blobfile #file handle - not the name of the file
    ...
    rv_plot = runprog(filepath1,namesample,filepath2,DBname,phaselistname)
