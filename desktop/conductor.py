...
def activatephases(mineral, selectedphases):
    '''  
...
def Qanalyze(userData, difdata, phaselist, selectedphases, instrParams):
    """
    ...
    FWHMa = instrParams['FWHMa']
    FWHMb = instrParams['FWHMb']
    ...
    mineral, RIR = extractlists(phaselist)
    enable = activatephases(mineral, selectedphases)
